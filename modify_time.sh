...
ls -rt|awk '/[0-9]+-[0-9]+-[0-9]+/{i=match($0,/[0-9]+-[0-9]+-[0-9]+/);j=match($0,/\..*/);str=substr($0,i,j-i);print i,j,str;split(str,A,-);str=sprintf(%4d%02d%02d0000,A[1],A[2],A[3]);print str;system(touch $0 -t str)}'
